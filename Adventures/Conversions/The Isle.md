...
title: The Isle
description: A Liminal Horror conversion for The Isle by Luke Gearing. Uses the Dwindling Party (funnel) supplemental ruleset for Liminal Horror.
---

# The Isle

- **Adventure:** [The Isle](https://spearwitch.itch.io/the-isle) by [Luke Gearing](https://lukegearing.blot.im/).
- **System:** [The Vanilla Game](https://vanillagame.carrd.co/)
...
A straight forward framing is almost the best. The Investigators are directly employed by an organization ([The Archivist](https://liminalhorrorrpg.com/resources/Factions/The%20Archivist/), [Panopticon](https://liminalhorrorrpg.com/resources/Factions/Panopticon/) or [The Bureau](https://liminalhorrorrpg.com/resources/Factions/The%20Bureau/)) to recover what is hidden deep within the Isle. This can be as straightforward as needed, with a few hooks placed to draw them in. The book recommends an alternative of having it be a mission from the Catholic Church, which I think gives a good sense of the type of setup you can deploy at your table. You could also have the adventure setup be a group of independent researchers hoping to track down a religiously significant artifact that is rumored to be on the island.
...
(Page 22) 14. The morale check made by the Bonded Dead (if wearing the mask) can be found here: [https://liminalhorrorrpg.com/core-rules/#morale]( https://liminalhorrorrpg.com/core-rules/#morale). Legionaries stats can be found on page 43.
...
(Page 27) **Encounter**s: Use the encounter procedure as written.
...
(Page 42) **Encounter**s: Use the encounter procedure as written.
...
(Page 57) **Encounter**s: Use the encounter procedure as written.
