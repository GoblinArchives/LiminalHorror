...
1. 1. Use the [Liminal Horror provided fallouts](https://liminalhorrorrpg.com/fallout-expanded/). It will allow for the table to continue on with any surviving characters after the events of this adventure.
2. Use the Po-Hu Touch [d8] table as fallouts, forcing players to continue on as their heroes are weighed down by the effects of the uplift spores. Exclude the note that the results are the last moment of consciousness.
3. Custom Fallouts: Create your own [custom fallouts](https://liminalhorrorrpg.com/srd-fallout/) tailored to Let Us In. An examples of custom fallouts:
