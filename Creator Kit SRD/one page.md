...
* [Licensing](#licensing)  
* [Scenario Front and Back Matter](#scenario-front-and-back-matter)  
* [Rules and Mechanics](#rules-and-mechanics)  
* [Making an Investigator](#making-an-investigator)  
* [Equipment](#equipment)  
* [Encounter Procedures](#encounter-procedures)  
* [Location Generators](#location-generators)  
* [Room Keying](#room-keying)  
* [Doom Clock](#doom-clock)  
* [Fallout](#fallout)  
* [Rituals](#rituals)  
* [Creating Horrors](#creating-horrors)  
* [Horrors with an Open License](#horrors-with-an-open-license)  
...
This system reference document is a collection of mechanics, rules, and content that can be used by designers to freely make and publish ttrpg products that are compatible with the [Liminal Horror RPG](https://liminalhorrorrpg.com/). Liminal Horror at its base is a rules-lite, adaptable survival-horror roleplaying game about normal characters and their struggles against monsters that haunt the night. The game focuses on surviving the weird and investigating horrors, blending simple, old-school inspired rules with modern, narrative first principles.
...
- Read the rules for free on the [Liminal Horror RPG website](https://liminalhorrorrpg.com/).
- Check out the [Liminal Horror Deluxe Edition](https://goblinarchives.itch.io/) for an in depth look at the rules (both for players and for Facilitators).
...
Since Liminal Horror Deluxe Edition is a rewritten copyrighted product we decided to release the SRD v3.0 (mechanics and lore text) under a [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/deed.en).

In order to support creators in making and publishing third party content, we have created a [Liminal Horror Third Party License](https://liminalhorrorrpg.com/3pp/) as an option for designers.

## [Liminal Horror Third Party License](https://liminalhorrorrpg.com/3pp/)  

We love community created content. We’ve created a Third Party License that allows anyone to make adventures, monsters, spells, content or mechanics for Liminal Horror and sell or publish for free without having to get approval from the Liminal Horror team. We want you to be able to write and publish your content, showcase that it is compatible with Liminal Horror and get it out there for others to use and play. That is why we have this license, and why we maintain the [Liminal Horror Library](https://liminalhorrorlibrary.com/) to catalogue and share your creations\!
...
Liminal Horror started as a hack of Cairn. The original text was written using Cairn’s original license [Creative Commons — Attribution-ShareAlike 4.0 International — CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/).  
...
Our overall design philosophy is often focused on how we can lower the barrier of entry for Facilitators and players. This is why the core rules are all [free online](https://liminalhorrorrpg.com/). Customers can buy your published work without any additional investment since they can get the base info for free.
...
* [*The Bureau* (2022)](https://goblinarchives.itch.io/the-bureau) included a page called: EMPLOYEE CODE OF CONDUCT (p. 4\) that featured an abbreviated version of the one-page rules reference (Abilities & Saves, HP, Inventory, Combat, Actions, Damage, Stress & Fallout, Healing, Deprived)  
* [*The Bloom* (2023)](https://goblinarchives.itch.io/the-bloom) included a page called: RULES TO TAKE NOTE (p. 4\) that featured five mechanics we felt would benefit emphasizing for Facilitators (Critical Damage and Wounds, Critical Stress and Fallout, Deprived, Healing, Vehicles).  
* [*EINFÜHLUNG* (2025)](https://goblinarchives.itch.io/einfhlung), our starter scenario, includes a complete rules reference in its introduction.

Additional rules reference explanation and text can be found in [SRD v2.0](https://liminalhorrorrpg.com/srdv2/) and [SRD v1.0](https://liminalhorrorrpg.com/srdv1/). The Rules Summary acts as a resource that you can include in your adventures.
...
5. **Without a Trace:** They’re gone. You’ve been searching, but no one seems to know anything. However, they weren’t the only ones to disappear under mysterious circumstances and you may have found a lead. **Take:** File of evidence, handgun (d6), deteriorated video message from that night.  
...
**4\. Backgrounds & Archetypes** Roll or choose a [Background](#backgrounds) or [Archetype](#archetypes).  
...
> Note: You can find more on Encounter Procedures in the [Liminal Horror Deluxe Edition (p. xxx-xxx)](https://goblinarchives.itch.io/liminal-horror-deluxe-edition).
...
2. A member of one of the [Factions](#factions) (link) or some sign of their involvement.  
...
7. Someone grappling with [Fallout](#fallout) (link).  
...
2. A [Resonant Artifact](#resonant-artifact) (link).  
...
* Omens  
* [Factions](#factions) (Link page)  
* [NPCs](#factions) (Link page)  
* [Horrors](#creating-horrors) (Link page)  
* [Resonant Artifacts](#resonant-artifacts) (Link page)
...
* **Abilities**: These should be thematically similar to the abilities of the horrors. The effects are typically either profound and dangerous or incredibly specific. When in doubt, borrow from a [Resonant Artifact](#resonant-artifacts) (link) or [Ritual](#rituals) (link). Simple abilities can be performed without issue, but the more powerful the ability the higher the cost, either causing Stress for the user or for those that witness it. Using the ability then creates a feedback loop where it may end up causing further Fallout.
...
For additional alternatives, see [Conditions](#conditions) (link).
...
Additional Fallout that has an open license that can be used are those included in [SRD v2.0](https://liminalhorrorrpg.com/srdv2/#fallout) and [SRD v1.0](https://liminalhorrorrpg.com/srdv1/#stress--fallout).
...
* If the Ritual triggers *Critical Stress* for the Investigator, it results in [Fallout](#fallout) (link) or a [Condition](#conditions) (link) depending on the nature of the Ritual.
...
2. We have included some [Horrors With An Open License](#horrors-with-an-open-license) that you can include in your scenarios. We’ve opened their license in hopes that some will use them to make scenarios. This section will be a living document, with us adding Horrors continually.
...
-	[Bureau Operator](bureau-operator)
-	[Bureau Sonorous](bureau-sonorous)
-	[Carrion Crier](carrion-crier)
-	[Child of the Spore](child-of-the-spore)
-	[Company Man](company-man)
-	[Cultists](cultists)
-	[Dark Ones](dark-ones)
-	[Dead Gods](dead-gods)
-	[Dissonant Artifacts](dissonant-artifacts)
-	[Fading](fading)
-	[Fleshsmith](fleshsmith)
-	[Frog Men](frog-men)
-	[Ghosts](ghosts)
-	[Goloch](goloch)
-	[Gremlins](gremlins)
...
-	[Mother](mother)
-	[ORCS](orcs)
-	[Pact Warlock](pact-warlock)
-	[Panopticon Analyst](panopticon-analyst)
-	[Panopticon Junior Executive](panopticon-junior-executive)
-	[Panopticon Upper Management](panopticon-upper-management)
-	[Puppets](puppets)
-	[Reanimated Dead](reanimated-dead)
...
- To propagate. To gestate. To herald Ammon.
- Critical Damage: Some of the spoors enter the victim's body.


## **Company Man**
**STR:** 14 **DEX:** 14 **CTRL:** 14  
**HP:** 13 **Armor:** 1  
...
3. **Mirror Step:** You create a portal out of a mirror, allowing you to enter the Mirror Dimension.  
4. **Staining Mark**: You place a mark on an object or being. For the Ritual’s duration, you can see their location, across any distance or space.  
5. **Edema:** Fill a target’s lungs with fluid. The target takes d4 damage every round until they can pass a STR Save to expel the fluid.  
6. **Blood Forge:** You extract your blood and coalesce it into a weapon, making your next attack *Enhanced*. Take d4 damage.  
7. **Apotropo:** Creates a protective barrier against other Rituals for the duration.  
8. **Static Shock:** Energy cascades from your fingertips in multiple arcs. It is difficult to control and aim, dealing *blast* damage and hitting all individuals within the target area.
...
* **[Rituals](#rituals) (link):** Avatars have access to Rituals that have a thematic connection to their Dead God.  
...
* **Special Ability:** Choose 1-2 [Rituals](https://liminalhorrorrpg.com/srd-rituals/) that instead act as at will abilities.  
* **Special Ability:** An ability that impacts how the creature moves, allowing it to ambush or get the drop on its targets.
...
**HP**: 6 **Armor**: 2  
Slam (d6)  
In the same vein as [Resonant Artifacts](https://liminalhorrorrpg.com/srd-resonant-artifacts/), Dissonant Artifacts are seemingly mundane objects that house power through a connection to resonant energies from other dimensions or planes of existence. But in contrast, these objects are often aniconic, which makes them chaotic and dangerous. Their power cannot be controlled in a utilitarian sense, so the best course of action is generally to destroy or contain them before others are exposed to the dangers they possess.
...
## **Fading**
**STR:** 12 **DEX:** 15 **CTRL:** 14  
**HP:** 10 **Armor:** 2  
Tentacle (d10, Blast)

- The last echos of a Dead God.
...
4. Contained [Lesser Horror](https://liminalhorrorrpg.com/srd-horrors/#horrors)
5. Contained [Greater Horror](https://liminalhorrorrpg.com/srd-horrors/#horrors)
...
- All attacks made against them are *Impaired*.


## **The Swarm**
**STR:** 14 **DEX:** 10 **CTRL:** 10  
**HP:** 10 **Armor:** 3  
...
4. **Bound:** Their essence is bound to \_\_\_\_. They are unable to travel far from it.   
5. **Charm:** Target obeys \_\_\_\_'s command. CTRL save once per round (or if they take damage) to break free.  
...
11. **Hypnotic Gaze:** Target looking into \_\_\_\_'s eyes becomes hypnotized. While they are under \_\_\_'s will, they cannot be driven to violence they would not normally commit.  
12. **Interdimensional Will:** They have the ability to fly, shape shift, and shape matter.   
13. **Obfuscate:** Target becomes confused, slowly moving further from \_\_\_\_\_. Target makes a CTRL save once per round to break free.  
...
24. **Soul Conduit:** \_\_\_\_ can survive material and metaphysical destruction, rebuilding anew, due to their binding their soul to an inanimate object. As long as that remains intact their essence will persist.  
25. **Spatial Mastery:** Can teleport a target in eyesight to a nearby location.  
26. **Stony Gaze:** Target, who remains in the eyesight of \_\_\_\_, slowly turns to stone over three rounds (first legs, then torso, then arms and head).  Blood directly from \_\_\_\_ heart is required to reverse the petrification.   
27. **Team Training:** When they attack act as a squad, dealing Enhanced damage and attacks against them are Impaired.  
28. **Trickster:** The \_\_\_ can teleport, become invisible, shape shift, and bring inanimate objects to life.   
...
1. **Amputate:** Critical Damage caused by \_\_\_ results in an amputated limb (Wound). Any who sees this takes 1d4 Stress.  
2. **Brainless:** If Critical Damage is triggered, \_\_\_ will create an opening in the target's skull. If an additional instance of Critical Damage occurs, \_\_\_ will rip the brain out of the opening, swallowing it whole.   
3. **Constrict:** Upon dealing Critical Damage, \_\_ entrangles the target, pulling them up as they choke them. Suffocation will occur in a matter of minutes.  
4. **Devastation:** If \_\_\_ deals Critical Damage to a target, all STR lost become permanent.   
5. **Devour:** If \_\_ deals Critical Damage they will begin to eat the target alive (target loses an additional d4 STR).  
6. **Drained:** If Critical Damage is triggered, the target becomes Deprived until they get restful sleep.  
7. **Eaten Whole:** If Critical Damage is triggered, \_\_ will swallow the target whole, dealing  an additional d6 STR damage from its stomach acid.  
...
9. **Gore:** Critical Damage caused by \_\_\_ results in the Disemboweled (Wound). The target will die in 1d2 hours unless they receive medical attention. Any who sees this takes 1d4 Stress.  
10. **Liquify:** If Critical Damage is triggered \_\_\_ will inject a caustic venom, liquifying the target’s insides, resulting in a permanent d6 STR loss.   
...
13. **Possession:** If Critical Damage is triggered the target must also make a CTRL save or become possessed by the \_\_\_.  
14. **Return to Nature:** When \_\_\_ deals Critical Damage, the target begins to have plants grow out of their Wounds.   
...
16. **Spirit Drain:** If Critical Damage is triggered, the target loses an additional d6 CTRL as their soul is slowly consumed by the \_\_\_.   
17. **Spraying Blood:** When \_\_ deals Critical Damage, the Wound erupts in a geyser of blood, restoring any lost HP or STR by the \_\_\_\_.  
...
19. **Undoing:** Attacks by \_\_\_ sever the binds of reality. Upon dealing Critical Damage, the target loses an additional d4 STR. If the target's STR reaches 0, they untether from the material plan, becoming a \_\_\_.   
...
Objects and entities that are deemed a significant threat are either terminated or captured and held in containment in the Monolith for further study. This includes an extensive collection of [Resonant Artifacts](#resonant-artifacts) (link), which are occasionally wielded by agents during investigations.
...
1. Create a Greater Horror to be their champion.  
2. Summon a Greater Horror to receive a blessing.  
3. Bind Lesser Horrors to their service.  
4. Scry the location of a Resonant Artifact.  
5. Fortify their body and souls in order to survive contact with their Dead God.  
6. Manifest prophetic visions.  
7. Open a gate or portal to another dimension or plane of existence.  
8. Bestow a boon upon the congregation.  
9. Bind a Resonant Artifact to their will.  
10. Transforming a human into the embodiment of a Dead God.
...
3. Item Tags  
4. Conditions  
5. Whisper Cards (The Mall)  
6. Claimed Locations (The Bloom)  
7. Kidnapping (Hungry Hollow)
...
1. As opposed to the full array of Attributes, normal folks have a single Save that collectively represents their STR, DEX, and CTRL. Roll 2d6 to determine each character’s Save.  
2. Roll d4 for each character to determine their Hit Protection (HP).  
3. Roll or choose Backgrounds for each character from either the abbreviated list on the next page or the standard list on page x. Note their associated items, as each character only has five Inventory Slots.  
4. Give your characters names, pronouns, and brief descriptive details.
...
The Cult infestation in [The Parthenogenesis of Hungry Hollow](https://goblinarchives.itch.io/the-parthenogenesis-of-hungry-hollow) provides a good example of how to create a mechanic that showcases escalating conflict/kidnapping from an antagonistic Faction. You can use this as a framework to adapt for a secret faction in your own scenario.
