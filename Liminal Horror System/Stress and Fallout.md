...
| 6                      | **The Weird:** You adopt a strange behavior that makes others uncomfortable. If you resist indulging in your “Weird” for 24 hours, take the Deprived tag. If others see you engage in this unsettling behavior, they must make a CTRL save or take 1d4 Stress.<br>After the first instance, roll 3d6. If the total is higher than your current CTRL, take the new result. |
...
| 10                     | **Magical Corruption** *(this can be taken multiple times per character)*: Flesh is weak. Roll on the Magical Fallout Table - [Mutations](/Liminal Horror System/Chaos Magic/#magical fallout tables)                                                                                                                                                                                    |
...
| 18                     | **Fate’s Web** *(this can only be taken once per character but multiple times per table)*: At least a puppet can see the strings that bind it, if only you were so lucky. <br>Roll on the Magical Fallout Table - [Omens/Magical Catastrophes](/Liminal Horror System/Chaos Magic/#magical-fallout tables)                                                                                                              |
