...
* **Abilities**: These should be thematically similar to the abilities of the horrors. The effects are typically either profound and dangerous or incredibly specific. When in doubt, borrow from a [Resonant Artifact](https://liminalhorrorrpg.com/srd-resonant-artifacts/) or [Ritual](https://liminalhorrorrpg.com/srd-rituals/). Simple abilities can be performed without issue, but the more powerful the ability the higher the cost, either causing Stress for the user or for those that witness it. Using the ability then creates a feedback loop where it may end up causing further Fallout.
...
For additional alternatives, see [Conditions](https://liminalhorrorrpg.com/srd-conditions/).
...
---
Next Section: [Rituals](https://liminalhorrorrpg.com/srd-rituals/)
<br>Previous Section: [Doom Clock](https://liminalhorrorrpg.com/srd-doom-clock/)
