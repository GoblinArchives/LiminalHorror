...
| NPCs                   | Create a list of important NPCs with their stat blocks. Use the [Horrors with an Open License](https://liminalhorrorrpg.com/srd-horrors/) for some example monsters or create them using the [Creating Horrors](https://liminalhorrorrpg.com/srd-one-page/#creating-horrors) Guidance. |
